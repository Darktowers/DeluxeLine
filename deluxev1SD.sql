...
--
-- Servidor: localhost
-- Tiempo de generación: 25-09-2015 a las 17:49:25
...
ALTER TABLE `datos`
  ...
  ADD KEY `fkIdUsuarios` (`fkIdUsuarios`),
  ADD KEY `fkIdTIpoDatos` (`fkIdTIpoDatos`);
...
ALTER TABLE `habitacion`
  ...
  ADD KEY `fkIdTipoHabitacion` (`fkIdTipoHabitacion`),
  ADD KEY `fkIdTipoEstado` (`fkIdTipoEstado`);
...
ALTER TABLE `habitacionServicio`
  ...
  ADD KEY `fkIdHabitacion` (`fkIdHabitacion`),
  ADD KEY `fkIdEstadoHS` (`fkIdEstadoHS`),
...
ALTER TABLE `ofertas`
  ...
  ADD KEY `fkIdTipoHabitacion` (`fkIdTipoHabitacion`),
  ADD KEY `fkIdTipoOferta` (`fkIdTipoOferta`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fkIdRolUsuario` (`fkIdRolUsuario`);
