...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2015 a las 05:29:58
...
INSERT INTO `servicio` (`idServicio`, `nombreServicio`, `fkTipoServicio`) VALUES
(1, 'Aire Acondicionado', 1),
(2, 'Internet', 1),
(3, 'Cama Doble', 1),
(4, 'Baño + Tina', 1),
(5, 'Televisor LCD + Cable', 2),
(6, 'Todo para preparar cafe', 1),
(7, 'Sala', 2),
(8, 'Mesa para Portatil', 2),
(9, '2 Camas Dobles', 3),
(10, 'Baño Grande + Tina', 2),
(11, 'Parqueadero', 3),
(12, 'Reproductor de DVD', 3),
(13, '2 Baños + Tina', 3),
(14, 'Parqueadero Doble', 3),
(15, 'Frutas Frescas', 3),
(16, 'Telefono', 1),
(17, 'Bebidas', 4),
(18, 'Alimentos', 4),
...
--
ALTER TABLE `habitacionservicio`
MODIFY `idHabitacionServicio` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113;
--
